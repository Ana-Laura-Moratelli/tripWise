        ...
        <View style={styles.container}>
            ...
            <View style={styles.loginContainer}>
                <View style={styles.tabs}>
                    <TouchableOpacity style={styles.inactiveTab} onPress={() => router.push('/screens/Login')}>
                ...
                <View style={styles.inputContainer}>
                    <TextInput placeholder="Nome" style={styles.input} placeholderTextColor="#888"/>
                    <TextInput placeholder="Telefone" style={styles.input} placeholderTextColor="#888"/>
                    <TextInput placeholder="CPF" style={styles.input} placeholderTextColor="#888"/>
